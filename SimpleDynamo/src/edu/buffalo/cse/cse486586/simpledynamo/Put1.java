...
public class Put1 implements OnClickListener {
	...
	public Put1(TextView _tv, ContentResolver _cr) {
		mTextView = _tv;
	...
	private class Task extends AsyncTask<Void, String, Void> {
		...
		protected Void doInBackground(Void... params) {
			publishProgress("Put1 Inserting...\n");
			if (testInsert()) {
				publishProgress("Put1 Insert success\n");
			} else {
				publishProgress("Put1 Insert fail\n");
				return null;
			}			
			return null;
		}
