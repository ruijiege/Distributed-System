...
public class Put3 implements OnClickListener {
	...
	public Put3(TextView _tv, ContentResolver _cr) {
		mTextView = _tv;
	...
	private class Task extends AsyncTask<Void, String, Void> {
		...
		protected Void doInBackground(Void... params) {
			publishProgress("Put3 Inserting...\n");
			if (testInsert()) {
				publishProgress("Put3 Insert success\n");
			} else {
				publishProgress("Put3 Insert fail\n");
				return null;
			}			
			return null;
		}
