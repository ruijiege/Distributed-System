...
public class OnPTestClickListener implements OnClickListener {
    ...
    public OnPTestClickListener(TextView _tv, ContentResolver _cr) {
        ...
        //mUri=Uri.parse("content://edu.buffalo.cse.cse486586.groupmessenger.provider/message");
        ...
        try {
            for (int i = 0; i < TEST_CNT; i++) {
                ...
                if (keyIndex == -1 || valueIndex == -1) {
                    ...
                    System.out.println("Wrong columns");
                    resultCursor.close();
                    throw new Exception();
                }
                ...
                if (!(returnKey.equals(key) && returnValue.equals(val))) {
                    ...
                    System.out.println("(key, value) pairs don't match\n");
                    resultCursor.close();
                    throw new Exception();
                }
